...
import { CreateCategoriesModalComponent } from './modals/categories/create-categories-modal/create-categories-modal.component';
import { MaterialModule } from '../material/material.module';
import { ReactiveFormsModule } from '@angular/forms';
import { CreateSubcategoriesModalComponent } from './modals/subcategories/create-subcategories-modal/create-subcategories-modal.component';
import { CreateProvidersModalComponent } from './modals/providers/create-providers-modal/create-providers-modal.component';
...
import { CreateDedicationsModalComponent } from './modals/dedications/create-dedications-modal/create-dedications-modal.component';
import { EditDedicationsModalComponent } from './modals/dedications/edit-dedications-modal/edit-dedications-modal.component';
