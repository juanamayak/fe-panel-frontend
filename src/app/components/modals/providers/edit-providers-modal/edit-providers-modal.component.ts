...
export class EditProvidersModalComponent implements OnInit{
    ...
    initForm(){
        this.providersForm = this.formBuilder.group({
            ...
            responsable_name: [this.provider.responsable_name, Validators.required],
            responsable_lastname: [this.provider.responsable_lastname, Validators.required],
            responsable_email: [this.provider.responsable_email, Validators.required],
            responsable_cellphone: [this.provider.responsable_cellphone, Validators.required]
        });
    }
    ...
    editProvider(){
        ...
        this.providersService.updateProviders(this.provider.uuid, data).subscribe({
            next: res => {
                this.spinner.hide();
