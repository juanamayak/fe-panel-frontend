...
export class CouponsService {
    ...
    updateCoupons(couponUuid: any, data: any): Observable<any>{
        return this.httpClient.post(`${this.url}/coupons/update/${couponUuid}`, data);
    }

    updateStatus(couponUuid, data): Observable<any>{
        return this.httpClient.put(`${this.url}/coupons/status/${couponUuid}`, data);
    }

    deleteCoupon(couponUuid): Observable<any>{
        return this.httpClient.put(`${this.url}/coupons/delete/${couponUuid}`, {});
    }
}
